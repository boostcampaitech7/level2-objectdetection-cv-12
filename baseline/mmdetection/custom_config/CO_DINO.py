...
load_from = './work_dirs/Avengers_Co-DETR/epoch_23.pth'
load_pipeline = [
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/data/ephemeral/home/level2-objectdetection-cv-04/dataset/',
        metainfo=dict(
            classes=(
                'General trash',
                'Paper',
...
test_evaluator = dict(
    _scope_='mmdet',
    ann_file=
    '/data/ephemeral/home/level2-objectdetection-cv-04/dataset/test.json',
    backend_args=None,
    classwise=False,
    format_only=False,
    metric='bbox',
    outfile_prefix='./work_dirs/Avengers_Co-DETR',
    type='CocoMetric')
test_pipeline = [
    dict(backend_args=None, type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
train_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='k-fold-final/train_fold_1.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root='/data/ephemeral/home/level2-objectdetection-cv-04/dataset/',
...
val_evaluator = dict(
    _scope_='mmdet',
    ann_file=
    '/data/ephemeral/home/level2-objectdetection-cv-04/dataset/k-fold-final/val_fold_1.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
visualizer = dict(
    ...
    vis_backends=[
        dict(
            init_kwargs=dict(name='Avengers_CO-DETR_fold1', project='Detr'),
            type='WandbVisBackend'),
    ])
work_dir = './work_dirs/Avengers_Co-DETR'
