...
train_pipeline = [
    ...
    dict(
        type='RandomResize',
        scale=[(1000, 240), (1000, 600)], #[(250, 60), (250, 150)], #[(1000, 240), (1000, 600)], #[(2000, 480), (2000, 1200)],
        keep_ratio=True,
        backend='pillow'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file="k-fold-final/cleanV2.json",
        data_prefix=dict(img=""),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + "k-fold-final/val_fold_8.json",
    metric='bbox',
    classwise=True,
    format_only=False,
    backend_args=backend_args)
